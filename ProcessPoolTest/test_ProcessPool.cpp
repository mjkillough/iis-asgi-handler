...
{
    EXPECT_EQ(ProcessPoolPublic::EscapeArgument("test"), "test");
}

TEST(ProcessPoolEscapeArgument, Spaces)
{
    EXPECT_EQ(ProcessPoolPublic::EscapeArgument("a space"), "\"a space\"");
}

TEST(ProcessPoolEscapeArgument, Quote)
{
    // Quotes should be escaped.
    EXPECT_EQ(ProcessPoolPublic::EscapeArgument("a \"test\""), "\"a \\\"test\\\"\"");
}
...
TEST(ProcessPoolEscapeArgument, Backslashes)
{
    ...
    EXPECT_EQ(ProcessPoolPublic::EscapeArgument("test \\\" str"), "\"test \\\\\\\" str\"");
